...
bg_data <- data %>% 
  ...
  select(BlockGroup, Qij, Qij_18, Qij_45, Qij_65)
...
tract_data <- tract_data %>%
  mutate(S_i= Ni_1*f_1 + Ni_2*f_2 + Ni_3*f_3, # composite MOS for PSU i 
         n_i_18 = n_avg*fd_1*Ni_1/S_i,
         n_i_45 = n_avg*fd_2*Ni_2/S_i,
         n_i_65 = n_avg*fd_3*Ni_3/S_i,
...
bg_data <- bg_data %>%
  mutate(S_ij= Qij_18*f_1 + Qij_45*f_2 + Qij_65*f_3, # composite MOS for SSU j at PSU i 
         qij_18 = q_avg*fd_1*Qij_18/S_ij,
         qij_45 = q_avg*fd_2*Qij_45/S_ij,
         qij_65 = q_avg*fd_3*Qij_65/S_ij) 
```
