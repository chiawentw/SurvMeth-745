...
$$\pi_i = m_{PSU} \frac{S_i}{S_+}, \quad \pi_{j|i} = m_{SSU} \frac{S_{j|i}}{S_i}$$ 
...
#   geom_bar(aes(y = percentage, fill = group), position = "stack", stat = "identity") +
...
ggplot(selected_characteristics_long, aes(x = BlockGroup, y = percentage, fill = AgeGenderGroup)) +
  ...
  labs(title = "Percentage of Age and Gender Groups within each Selected BG",
       x = "Selected Block Groups",
       y = "Percentage") +
  scale_fill_manual(values = c("age_18_male" = "blue", "age_45_male" = "green", "age_65_male" = "red", 
                               "age_18_female" = "lightblue", "age_45_female" = "lightgreen", "age_65_female" = "pink"),
