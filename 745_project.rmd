...
# Plot
ggplot(selected_characteristics, aes(x = BlockGroup)) +
  geom_bar(aes(y = percentage, fill = percenta), position = "stack", stat = "identity") +
  labs(title = "Percentage of Age and Gender Groups within each Selected Block Groups",
       x = "Selected Block Groups",
       y = "Percentage") +
  scale_fill_manual(values = c("age_18_male" = "blue", "age_45_male" = "green", "age_65_male" = "red", 
                                "age_18_female" = "lightblue", "age_45_female" = "lightgreen", "age_65_female" = "pink"),
